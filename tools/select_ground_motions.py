...
Usage:
    ...
    python3 tools/select_ground_motions.py --magnitude 6.5 8.0 --distance 0 100 --vs30 250 400
    python3 tools/select_ground_motions.py --mechanism subduction --records 11
    python3 tools/select_ground_motions.py --flatfile db/excitation/flatfiles/nga_sub_flatfile.csv
"""
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        ...
        epilog=(
            "Examples:\n"
            "  python3 tools/select_ground_motions.py\n"
            "  python3 tools/select_ground_motions.py --magnitude 6.5 8.0 --vs30 250 400\n"
            "  python3 tools/select_ground_motions.py --mechanism subduction --records 11\n"
        ),
    )
    p.add_argument(
